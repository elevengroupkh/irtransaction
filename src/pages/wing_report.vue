    ...
    <q-card>
      ...
      >
        ...
        <template v-slot:body-cell-w2w="props">
          <q-td :props="props">
            <q-btn color="black" :to="'wing_report_detail?id='+props.row.id" label="w2w" class="q-mr-sm"/>
          </q-td>
        </template>
        ...
        <template v-slot:top="props">
          <div class="q-table__title">Wing Report</div>
          <div class="">
            <div class="row">
              <div class="col-12">
    ...
    export default {
        ...
        methods: {
            ...
            async getRecord() {
              ...
              /*await this.$axios.post('api/wingreport/getCashout')
              .then((response)=>{
                console.log(response)
              })*/

              await this.$axios.get('api/wingreport')
              .then((response)=>{
                console.log(response)
                this.data = response.data
                this.loading = false
